...
GlobalFonts.registerFromPath(
  "node_modules/welcomify/build/structures/font/Montserrat-Black.ttf",
  "montserrat-black"
);
GlobalFonts.registerFromPath(
  "node_modules/welcomify/build/structures/font/Montserrat-ExtraLight.ttf",
...
class Card {
  ...
  async build() {
    ...
    if (this.username.length >= 16) {
      throw new Error(
        `The username is too long to display on card [less than equal to 15]`
      );
    }

    if (this.title.length >= 16) {
      throw new Error(
        `The title is too long to display on card [less than equal to 15]`
      );
    }

    if (this.message.length >= 36) {
      throw new Error(
        `The message is too long to display on card [less than equal to 35]`
      );
    }
